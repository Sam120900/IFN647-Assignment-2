...
def load_queries(query_file_path):
    ...
    with open(query_file_path, 'r', encoding='utf-8') as file:
        ...
        for raw_query in raw_queries:
            ...
            narration = re.search(r'<narr>(.*?)\n', raw_query).group(1).strip()
            queries[number] = process_text(title + description + narration)
    return queries
...
def calculate_bm25(N, avgdl, documents, queries, df, k1=1.2, k2=500, b=0.75):
...
# Example usage
query_file_path = 'C:\\Users\\samin\\Desktop\\IFN647\\Assignment 2\\the50Queries.txt'  # Adjust this path to where your actual query file is located.
base_data_directory = 'C:\\Users\\samin\\Desktop\\IFN647\\Assignment 2\\Data_Collection-1\\Data_Collection'  # E.g., 'data_collections'
output_folder = 'Outputs-Task4_BM25'

queries = load_queries(query_file_path)
all_scores = {}

for i in range(101, 151):  # Assumes data collections are named sequentially from Data_C101 to Data_C150
